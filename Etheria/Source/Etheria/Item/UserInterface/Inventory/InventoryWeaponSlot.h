...
public:
	UPROPERTY()
	class AEPlayer* PlayerCharacter;

	FORCEINLINE void SetSlotType(EWeaponType Type) { SlotType = Type; }
	FORCEINLINE EWeaponType GetSlotType() { return SlotType; }
...
protected:
	...
	/// Variables
	/// </summary>
	UPROPERTY(EditDefaultsOnly, Category = "Inventory Weapon Slot");
