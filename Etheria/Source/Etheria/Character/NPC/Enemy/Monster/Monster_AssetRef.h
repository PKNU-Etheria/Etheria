...
#define CACTUS_ATTACK_MOTION TEXT("/Script/Engine.AnimSequence'/Plugins_AssetShare/MonsterForSurvivalGame/Animation/Polyart/Cactus/Cactus_Attack01_ANIM.Cactus_Attack01_ANIM'")
#define CACTUS_GETHIT_MOTION TEXT("/Script/Engine.AnimSequence'/Plugins_AssetShare/MonsterForSurvivalGame/Animation/Polyart/Cactus/Cactus_GetHit_ANIM.Cactus_GetHit_ANIM'")

#define CHEST_DEAD_MOTION TEXT("/Script/Engine.AnimSequence'/Plugins_AssetShare/MonsterForSurvivalGame/Animation/Polyart/ChestMonster/ChestMonster_Die_ANIM.ChestMonster_Die_ANIM'")
...
#define SLIME_ATTACK_MOTION TEXT("/Script/Engine.AnimSequence'/Plugins_AssetShare/MonsterForSurvivalGame/Animation/Polyart/Slime/Slime_Attack02_ANIM.Slime_Attack02_ANIM'")
#define SLIME_GETHIT_MOTION TEXT("/Script/Engine.AnimSequence'/Plugins_AssetShare/MonsterForSurvivalGame/Animation/Polyart/Slime/Slime_GetHit_ANIM.Slime_GetHit_ANIM'")

#define TURTLESHELL_DEAD_MOTION TEXT("/Script/Engine.AnimSequence'/Plugins_AssetShare/MonsterForSurvivalGame/Animation/Polyart/TurtleShell/TurtleShell_Die_ANIM.TurtleShell_Die_ANIM'")
#define TURTLESHELL_ATTACK_MOTION TEXT("/Script/Engine.AnimSequence'/Plugins_AssetShare/MonsterForSurvivalGame/Animation/Polyart/TurtleShell/TurtleShell_Attack01_ANIM.TurtleShell_Attack01_ANIM'")
#define TURTLESHELL_GETHIT_MOTION TEXT("/Script/Engine.AnimSequence'/Plugins_AssetShare/MonsterForSurvivalGame/Animation/Polyart/TurtleShell/TurtleShell_GetHit_ANIM.TurtleShell_GetHit_ANIM'")